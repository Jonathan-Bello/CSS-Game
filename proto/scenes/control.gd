...
<style>
  ...
  .bar{display:flex;gap:8px;padding:8px;background:#0b1222cc;border-bottom:1px solid #335}
  ...
  textarea{width:100%;height:120px;margin:8px;background:#0b1222;color:#bfe;border:1px solid #345;border-radius:8px}
